...
class BusControllerTest {
    ...
    void testBookSeat_PassengerMismatch() {
        BookingDTO dto = new BookingDTO();
        dto.setBusId(1L);
        dto.setSeatIds(List.of(101L, 102L));
        ...
        when(seatService.getSeatsByIds(dto.getSeatIds())).thenReturn(Arrays.asList(seat1, seat2));
    ...
    void testBookSeat_SuccessfulBooking() {
        ...
        when(seatService.getSeatsByIds(dto.getSeatIds())).thenReturn(List.of(seat));
